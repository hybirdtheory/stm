...
{
    public class SysConfigClient : ISysConfigClient
    {

        private static ConcurrentDictionary<string, SysConfigInfo> _configs;
        ...
        static SysConfigClient ()
        {
            _configs = new ConcurrentDictionary<string, SysConfigInfo>();
        ...
        internal static async Task OnTickAsync ( IServiceProvider serviceProvider)
        {
            ...
            var configService= serviceProvider.GetService<ISysConfigService>();
